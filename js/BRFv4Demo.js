...
brfv4Example.start = function() {
	...
	brfv4Example.loader.preload([
		...
		"assets/brfv4_face_textures.js", //need this for facetracking, but not anything else
		"js/examples/face_tracking/face_texture_overlay.js"		// start with this example
